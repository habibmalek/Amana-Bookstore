...
// Copy your complete books array from src/app/data/books.ts here
const books = [
  // Your books data from src/app/data/books.ts
  // Copy the entire array from that file
    {
      id: '1',
    ...
    },
    {
      ...
      {
      id: '46',
      title: 'pace of winning and victory Theory',
      author: 'Prof. Habib Othman',
      description: 'winning mentality, planning strategy for winning, victory dynamics, and victory aspects processing.',
      price: 199.95,
      image: '/images/book3.jpg',
      isbn: '972-0599969737',
      genre: ['Philosophy', 'Sustainability'],
      tags: ['Winning Mentality', 'Victory Dynamics', 'Strategic Planning'],
      datePublished: '2022-10-13',
      pages: 1111,
      language: 'English',
      publisher: 'Al-Qahaar Biss Deeni',
      rating: 4.9,
      reviewCount: 64,
      inStock: true,
      featured: true,
...
// Copy your complete reviews array from src/app/data/reviews.ts here
const reviews = [
  // Your reviews data from src/app/data/reviews.ts  
  // Copy the entire array from that file
    {
      id: 'review-1',
      bookId: '1',
...
async function fullMigrate() {
  ...
  try {
    ...
    try {
      ...
      console.log('📚 Books collection did not exist');
    }
    ...
    try {
      ...
      console.log('🛒 Carts collection did not exist');
    }
    ...
    console.log(`\n🔍 Sample: "${sampleBook.title}" by ${sampleBook.author}`);
